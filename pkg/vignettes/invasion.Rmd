...
data(cypa_data)
summary(cypa_data)
#>       plant_id       Inf2.94             Inf.94            Veg.94           Inf2.95              Inf.95           Veg.95      
#>  K NA     :  28   Min.   :0.000000   Min.   :0.00000   Min.   :0.00000   Min.   :0.0000000   Min.   :0.0000   Min.   :0.0000  
#>  A NA     :  18   1st Qu.:0.000000   1st Qu.:0.00000   1st Qu.:0.00000   1st Qu.:0.0000000   1st Qu.:0.0000   1st Qu.:0.0000  
#>  T NA     :  11   Median :0.000000   Median :0.00000   Median :0.00000   Median :0.0000000   Median :0.0000   Median :0.0000  
#>  Willow NA:  11   Mean   :0.001787   Mean   :0.06971   Mean   :0.02234   Mean   :0.0008937   Mean   :0.1698   Mean   :0.1528  
#>  Aspen NA :  10   3rd Qu.:0.000000   3rd Qu.:0.00000   3rd Qu.:0.00000   3rd Qu.:0.0000000   3rd Qu.:0.0000   3rd Qu.:0.0000  
#>  X NA     :   7   Max.   :1.000000   Max.   :4.00000   Max.   :4.00000   Max.   :1.0000000   Max.   :4.0000   Max.   :7.0000  
#>  (Other)  :1034                                                                                                               
#>     Inf2.96             Inf.96           Veg.96          Inf2.97      Inf.97           Veg.97          Inf2.98        
#>  Min.   :0.000000   Min.   :0.0000   Min.   :0.0000   Min.   :0   Min.   :0.0000   Min.   :0.0000   Min.   :0.000000  
#>  1st Qu.:0.000000   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.000000  
#>  Median :0.000000   Median :0.0000   Median :0.0000   Median :0   Median :0.0000   Median :0.0000   Median :0.000000  
#>  Mean   :0.001787   Mean   :0.2502   Mean   :0.2779   Mean   :0   Mean   :0.1314   Mean   :0.2967   Mean   :0.003575  
#>  3rd Qu.:0.000000   3rd Qu.:0.0000   3rd Qu.:0.0000   3rd Qu.:0   3rd Qu.:0.0000   3rd Qu.:0.0000   3rd Qu.:0.000000  
#>  Max.   :1.000000   Max.   :6.0000   Max.   :6.0000   Max.   :0   Max.   :4.0000   Max.   :7.0000   Max.   :1.000000  
#>                                                                                                                       
#>      Inf.98          Veg.98          Inf2.99             Inf.99           Veg.99          Inf2.00             Inf.00      
#>  Min.   :0.000   Min.   :0.0000   Min.   :0.000000   Min.   :0.0000   Min.   :0.0000   Min.   :0.000000   Min.   :0.0000  
#>  1st Qu.:0.000   1st Qu.:0.0000   1st Qu.:0.000000   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.000000   1st Qu.:0.0000  
#>  Median :0.000   Median :0.0000   Median :0.000000   Median :0.0000   Median :0.0000   Median :0.000000   Median :0.0000  
#>  Mean   :0.252   Mean   :0.2887   Mean   :0.005362   Mean   :0.3119   Mean   :0.2797   Mean   :0.003575   Mean   :0.2038  
#>  3rd Qu.:0.000   3rd Qu.:0.0000   3rd Qu.:0.000000   3rd Qu.:0.0000   3rd Qu.:0.0000   3rd Qu.:0.000000   3rd Qu.:0.0000  
#>  Max.   :5.000   Max.   :5.0000   Max.   :1.000000   Max.   :7.0000   Max.   :4.0000   Max.   :1.000000   Max.   :6.0000  
#>                                                                                                                           
#>      Veg.00          Inf2.01             Inf.01           Veg.01          Inf2.02              Inf.02           Veg.02      
#>  Min.   :0.0000   Min.   :0.000000   Min.   :0.0000   Min.   :0.0000   Min.   :0.0000000   Min.   :0.0000   Min.   :0.0000  
#>  1st Qu.:0.0000   1st Qu.:0.000000   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.0000000   1st Qu.:0.0000   1st Qu.:0.0000  
#>  Median :0.0000   Median :0.000000   Median :0.0000   Median :0.0000   Median :0.0000000   Median :0.0000   Median :0.0000  
#>  Mean   :0.3503   Mean   :0.003575   Mean   :0.2011   Mean   :0.3718   Mean   :0.0008937   Mean   :0.2225   Mean   :0.2895  
#>  3rd Qu.:0.0000   3rd Qu.:0.000000   3rd Qu.:0.0000   3rd Qu.:1.0000   3rd Qu.:0.0000000   3rd Qu.:0.0000   3rd Qu.:0.0000  
#>  Max.   :6.0000   Max.   :1.000000   Max.   :5.0000   Max.   :5.0000   Max.   :1.0000000   Max.   :6.0000   Max.   :4.0000  
#>                                                                                                                             
#>     Inf2.03              Inf.03           Veg.03          Inf2.04              Inf.04            Veg.04          Inf2.05        
#>  Min.   :0.0000000   Min.   :0.0000   Min.   :0.0000   Min.   :0.0000000   Min.   :0.00000   Min.   :0.0000   Min.   :0.000000  
#>  1st Qu.:0.0000000   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.0000000   1st Qu.:0.00000   1st Qu.:0.0000   1st Qu.:0.000000  
#>  Median :0.0000000   Median :0.0000   Median :0.0000   Median :0.0000000   Median :0.00000   Median :0.0000   Median :0.000000  
#>  Mean   :0.0008937   Mean   :0.1921   Mean   :0.3646   Mean   :0.0008937   Mean   :0.09562   Mean   :0.2645   Mean   :0.002681  
#>  3rd Qu.:0.0000000   3rd Qu.:0.0000   3rd Qu.:1.0000   3rd Qu.:0.0000000   3rd Qu.:0.00000   3rd Qu.:0.0000   3rd Qu.:0.000000  
#>  Max.   :1.0000000   Max.   :6.0000   Max.   :6.0000   Max.   :1.0000000   Max.   :4.00000   Max.   :4.0000   Max.   :1.000000  
#>                                                                                                                                 
#>      Inf.05           Veg.05          Inf2.06              Inf.06            Veg.06          Inf2.07      Inf.07       
#>  Min.   :0.0000   Min.   :0.0000   Min.   :0.0000000   Min.   :0.00000   Min.   :0.0000   Min.   :0   Min.   :0.00000  
#>  1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.0000000   1st Qu.:0.00000   1st Qu.:0.0000   1st Qu.:0   1st Qu.:0.00000  
#>  Median :0.0000   Median :0.0000   Median :0.0000000   Median :0.00000   Median :0.0000   Median :0   Median :0.00000  
#>  Mean   :0.1189   Mean   :0.3029   Mean   :0.0008937   Mean   :0.03485   Mean   :0.1984   Mean   :0   Mean   :0.03217  
#>  3rd Qu.:0.0000   3rd Qu.:0.0000   3rd Qu.:0.0000000   3rd Qu.:0.00000   3rd Qu.:0.0000   3rd Qu.:0   3rd Qu.:0.00000  
#>  Max.   :6.0000   Max.   :4.0000   Max.   :1.0000000   Max.   :3.00000   Max.   :4.0000   Max.   :0   Max.   :3.00000  
#>                                                                                                                        
#>      Veg.07          Inf2.08      Inf.08           Veg.08          Inf2.09              Inf.09            Veg.09      
#>  Min.   :0.0000   Min.   :0   Min.   :0.0000   Min.   :0.0000   Min.   :0.0000000   Min.   :0.00000   Min.   :0.0000  
#>  1st Qu.:0.0000   1st Qu.:0   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.0000000   1st Qu.:0.00000   1st Qu.:0.0000  
#>  Median :0.0000   Median :0   Median :0.0000   Median :0.0000   Median :0.0000000   Median :0.00000   Median :0.0000  
#>  Mean   :0.1555   Mean   :0   Mean   :0.0563   Mean   :0.1224   Mean   :0.0008937   Mean   :0.08668   Mean   :0.1841  
#>  3rd Qu.:0.0000   3rd Qu.:0   3rd Qu.:0.0000   3rd Qu.:0.0000   3rd Qu.:0.0000000   3rd Qu.:0.00000   3rd Qu.:0.0000  
#>  Max.   :4.0000   Max.   :0   Max.   :3.0000   Max.   :4.0000   Max.   :1.0000000   Max.   :5.00000   Max.   :6.0000  
#>                                                                                                                       
#>     Inf2.10             Inf.10            Veg.10          Inf2.11             Inf.11          Veg.11      
#>  Min.   :0.000000   Min.   :0.00000   Min.   :0.0000   Min.   :0.000000   Min.   :0.000   Min.   :0.0000  
#>  1st Qu.:0.000000   1st Qu.:0.00000   1st Qu.:0.0000   1st Qu.:0.000000   1st Qu.:0.000   1st Qu.:0.0000  
#>  Median :0.000000   Median :0.00000   Median :0.0000   Median :0.000000   Median :0.000   Median :0.0000  
#>  Mean   :0.001787   Mean   :0.08311   Mean   :0.1644   Mean   :0.002681   Mean   :0.134   Mean   :0.1975  
#>  3rd Qu.:0.000000   3rd Qu.:0.00000   3rd Qu.:0.0000   3rd Qu.:0.000000   3rd Qu.:0.000   3rd Qu.:0.0000  
#>  Max.   :1.000000   Max.   :4.00000   Max.   :4.0000   Max.   :2.000000   Max.   :4.000   Max.   :4.0000  
#> 
```
...
### Pairwise invasibility analysis focused on matrix element manipulation
  ...
  <p style="text-indent: 20px">Our first example will focus on running pairwise invasibility analyses in which matrix elements are manipulated to create our pairs of residents and mutants. Because we use existing MPMs, the process is generally quite quick, and only slows when using giant matrices such as might occur in historical MPM projection. To make this process easier, we will develop a relatively small, stage-based empirical MPM</p>
...
``` r
cypraw_v1 <- verticalize3(data = cypa_data, noyears = 18, firstyear = 2004,
...
#> 
#> This hfv dataset contains 6871 rows, 57 variables, 1 population, 
#> 1 patch, 1025 individuals, and 17 time steps.
#>      rowid           popid             patchid               individ         year2        firstseen       lastseen   
#>  Min.   :   1.0   Length:6871        Length:6871        K NA     :  62   Min.   :2004   Min.   :2004   Min.   :2004  
#>  1st Qu.: 291.0   Class :character   Class :character   A NA     :  27   1st Qu.:2009   1st Qu.:2005   1st Qu.:2014  
#>  Median : 563.0   Mode  :character   Mode  :character   X NA     :  24   Median :2012   Median :2007   Median :2019  
#>  Mean   : 557.5                                         T NA     :  23   Mean   :2012   Mean   :2007   Mean   :2017  
#>  3rd Qu.: 820.0                                         Willow NA:  17   3rd Qu.:2015   3rd Qu.:2009   3rd Qu.:2021  
#>  Max.   :1119.0                                         X 3      :  17   Max.   :2020   Max.   :2020   Max.   :2021  
#>                                                         (Other)  :6701                                               
#>      obsage        obslifespan         sizea1             sizeb1           sizec1         size1added        repstra1     
#>  Min.   : 1.000   Min.   : 0.000   Min.   :0.000000   Min.   :0.0000   Min.   :0.0000   Min.   :0.0000   Min.   :0.0000  
#>  1st Qu.: 2.000   1st Qu.: 6.000   1st Qu.:0.000000   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.0000  
#>  Median : 5.000   Median :10.000   Median :0.000000   Median :0.0000   Median :0.0000   Median :1.0000   Median :0.0000  
#>  Mean   : 5.541   Mean   : 9.452   Mean   :0.003638   Mean   :0.3448   Mean   :0.5244   Mean   :0.8728   Mean   :0.3448  
#>  3rd Qu.: 8.000   3rd Qu.:14.000   3rd Qu.:0.000000   3rd Qu.:0.0000   3rd Qu.:1.0000   3rd Qu.:1.0000   3rd Qu.:0.0000  
#>  Max.   :17.000   Max.   :17.000   Max.   :1.000000   Max.   :7.0000   Max.   :7.0000   Max.   :7.0000   Max.   :7.0000  
#>                                                                                                                          
#>     repstrb1         repstr1added        feca1          fec1added        obsstatus1       repstatus1      fecstatus1    
#>  Min.   :0.000000   Min.   :0.0000   Min.   :0.0000   Min.   :0.0000   Min.   :0.0000   Min.   :0.000   Min.   :0.0000  
#>  1st Qu.:0.000000   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.000   1st Qu.:0.0000  
#>  Median :0.000000   Median :0.0000   Median :0.0000   Median :0.0000   Median :1.0000   Median :0.000   Median :0.0000  
#>  Mean   :0.003638   Mean   :0.3484   Mean   :0.3448   Mean   :0.3448   Mean   :0.5472   Mean   :0.247   Mean   :0.2463  
#>  3rd Qu.:0.000000   3rd Qu.:0.0000   3rd Qu.:0.0000   3rd Qu.:0.0000   3rd Qu.:1.0000   3rd Qu.:0.000   3rd Qu.:0.0000  
#>  Max.   :1.000000   Max.   :7.0000   Max.   :7.0000   Max.   :7.0000   Max.   :1.0000   Max.   :1.000   Max.   :1.0000  
#>                                                                                                                         
#>    matstatus1         alive1          stage1           stage1index        sizea2             sizeb2           sizec2      
#>  Min.   :0.0000   Min.   :0.0000   Length:6871        Min.   :0.000   Min.   :0.000000   Min.   :0.0000   Min.   :0.0000  
#>  1st Qu.:1.0000   1st Qu.:1.0000   Class :character   1st Qu.:4.000   1st Qu.:0.000000   1st Qu.:0.0000   1st Qu.:0.0000  
#>  Median :1.0000   Median :1.0000   Mode  :character   Median :5.000   Median :0.000000   Median :0.0000   Median :0.0000  
#>  Mean   :0.8395   Mean   :0.8395                      Mean   :4.145   Mean   :0.004803   Mean   :0.4091   Mean   :0.6656  
#>  3rd Qu.:1.0000   3rd Qu.:1.0000                      3rd Qu.:5.000   3rd Qu.:0.000000   3rd Qu.:1.0000   3rd Qu.:1.0000  
#>  Max.   :1.0000   Max.   :1.0000                      Max.   :8.000   Max.   :1.000000   Max.   :7.0000   Max.   :7.0000  
#>                                                                                                                           
#>    size2added       repstra2         repstrb2         repstr2added        feca2          fec2added        obsstatus2   
#>  Min.   :0.000   Min.   :0.0000   Min.   :0.000000   Min.   :0.0000   Min.   :0.0000   Min.   :0.0000   Min.   :0.000  
#>  1st Qu.:0.000   1st Qu.:0.0000   1st Qu.:0.000000   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.000  
#>  Median :1.000   Median :0.0000   Median :0.000000   Median :0.0000   Median :0.0000   Median :0.0000   Median :1.000  
#>  Mean   :1.079   Mean   :0.4091   Mean   :0.004803   Mean   :0.4139   Mean   :0.4091   Mean   :0.4091   Mean   :0.697  
#>  3rd Qu.:1.000   3rd Qu.:1.0000   3rd Qu.:0.000000   3rd Qu.:1.0000   3rd Qu.:1.0000   3rd Qu.:1.0000   3rd Qu.:1.000  
#>  Max.   :7.000   Max.   :7.0000   Max.   :1.000000   Max.   :7.0000   Max.   :7.0000   Max.   :7.0000   Max.   :1.000  
#>                                                                                                                        
#>    repstatus2       fecstatus2       matstatus2     alive2     stage2           stage2index        sizea3             sizeb3      
#>  Min.   :0.0000   Min.   :0.0000   Min.   :1    Min.   :1   Length:6871        Min.   :4.000   Min.   :0.000000   Min.   :0.0000  
#>  1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:1    1st Qu.:1   Class :character   1st Qu.:4.000   1st Qu.:0.000000   1st Qu.:0.0000  
#>  Median :0.0000   Median :0.0000   Median :1    Median :1   Mode  :character   Median :5.000   Median :0.000000   Median :0.0000  
#>  Mean   :0.2969   Mean   :0.2959   Mean   :1    Mean   :1                      Mean   :4.982   Mean   :0.004221   Mean   :0.3308  
#>  3rd Qu.:1.0000   3rd Qu.:1.0000   3rd Qu.:1    3rd Qu.:1                      3rd Qu.:5.000   3rd Qu.:0.000000   3rd Qu.:0.0000  
#>  Max.   :1.0000   Max.   :1.0000   Max.   :1    Max.   :1                      Max.   :8.000   Max.   :2.000000   Max.   :7.0000  
#>                                                                                                                                   
#>      sizec3         size3added        repstra3         repstrb3         repstr3added       feca3          fec3added     
#>  Min.   :0.0000   Min.   :0.0000   Min.   :0.0000   Min.   :0.000000   Min.   :0.000   Min.   :0.0000   Min.   :0.0000  
#>  1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.000000   1st Qu.:0.000   1st Qu.:0.0000   1st Qu.:0.0000  
#>  Median :0.0000   Median :1.0000   Median :0.0000   Median :0.000000   Median :0.000   Median :0.0000   Median :0.0000  
#>  Mean   :0.5523   Mean   :0.8874   Mean   :0.3308   Mean   :0.004221   Mean   :0.335   Mean   :0.3308   Mean   :0.3308  
#>  3rd Qu.:1.0000   3rd Qu.:1.0000   3rd Qu.:0.0000   3rd Qu.:0.000000   3rd Qu.:0.000   3rd Qu.:0.0000   3rd Qu.:0.0000  
#>  Max.   :7.0000   Max.   :7.0000   Max.   :7.0000   Max.   :2.000000   Max.   :7.000   Max.   :7.0000   Max.   :7.0000  
#>                                                                                                                         
...
#>  Mean   :0.571   Mean   :0.2391   Mean   :0.2384   Mean   :1    Mean   :0.874                      Mean   :4.301  
...
```
  ...
  <p style="text-indent: 20px">Next we need to define the desntiy dependence that we will use. In herbaceous perennial plants, the germination stage is most commonly negatively density dependent. In orchids, germination may be from a fresh seed, or from a previously dormant seed, and we will assume density dependence in both. Clarifying the exact nature and proper parameterization of density dependence is too great a topic for this vignette, and so we utilize the following two-parameter Ricker function-based approach, which we know works in this case.</p>
...
![plot of chunk ch1.8](ch1.8-1.png)
  ...
  <p style="text-indent: 20px">It appears that our mutant never gained a footing in the population, likely going extinct while the resident grew to a stable population size.</p>
  
  *****Need a summary statement here*****
  
  <p style="text-indent: 20px">Next, we can view the pairwise invasibility plot (PIP). This will give us a sense of whether we have any evolutionarily stable equilibria, or whether natural selection appears to completely directional.</p>
...
![plot of chunk ch1.9](ch1.9-1.png)
  ...
  <p style="text-indent: 20px">It appears that natural selection is completely directional here, favoring increasingly large multipliers.</p>
...
cypraw_v2 <- verticalize3(data = cypa_data, noyears = 18, firstyear = 1994,
  individcol = "plant_id", blocksize = 3, sizeacol = "Inf2.94",
  sizebcol = "Inf.94", sizeccol = "Veg.94", repstracol = "Inf.94",
  repstrbcol = "Inf2.94", fecacol = "Inf.94", fecbcol = "Inf2.94",
  stageassign = cypframe_fb, stagesize = "sizeadded", NAas0 = TRUE)
summary_hfv(cypraw_v2)
#> 
#> This hfv dataset contains 6871 rows, 60 variables, 1 population, 
#> 1 patch, 1025 individuals, and 17 time steps.
#>      rowid           popid             patchid               individ         year2        firstseen       lastseen   
...
#>  Median : 563.0   Mode  :character   Mode  :character   X NA     :  24   Median :2002   Median :1997   Median :2009  
#>  Mean   : 557.5                                         T NA     :  23   Mean   :2002   Mean   :1997   Mean   :2007  
#>  3rd Qu.: 820.0                                         Willow NA:  17   3rd Qu.:2005   3rd Qu.:1999   3rd Qu.:2011  
#>  Max.   :1119.0                                         X 3      :  17   Max.   :2010   Max.   :2010   Max.   :2011  
#>                                                         (Other)  :6701                                               
#>      obsage        obslifespan         sizea1             sizeb1           sizec1         size1added        repstra1     
#>  Min.   : 1.000   Min.   : 0.000   Min.   :0.000000   Min.   :0.0000   Min.   :0.0000   Min.   :0.0000   Min.   :0.0000  
#>  1st Qu.: 2.000   1st Qu.: 6.000   1st Qu.:0.000000   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.0000  
...
#>  Max.   :17.000   Max.   :17.000   Max.   :1.000000   Max.   :7.0000   Max.   :7.0000   Max.   :7.0000   Max.   :7.0000  
#>                                                                                                                          
#>     repstrb1         repstr1added        feca1            fecb1            fec1added        obsstatus1       repstatus1   
#>  Min.   :0.000000   Min.   :0.0000   Min.   :0.0000   Min.   :0.000000   Min.   :0.0000   Min.   :0.0000   Min.   :0.000  
#>  1st Qu.:0.000000   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.000000   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.000  
#>  Median :0.000000   Median :0.0000   Median :0.0000   Median :0.000000   Median :0.0000   Median :1.0000   Median :0.000  
#>  Mean   :0.003638   Mean   :0.3484   Mean   :0.3448   Mean   :0.003638   Mean   :0.3484   Mean   :0.5472   Mean   :0.247  
#>  3rd Qu.:0.000000   3rd Qu.:0.0000   3rd Qu.:0.0000   3rd Qu.:0.000000   3rd Qu.:0.0000   3rd Qu.:1.0000   3rd Qu.:0.000  
#>  Max.   :1.000000   Max.   :7.0000   Max.   :7.0000   Max.   :1.000000   Max.   :7.0000   Max.   :1.0000   Max.   :1.000  
#>                                                                                                                           
#>    fecstatus1      matstatus1         alive1          stage1           stage1index        sizea2             sizeb2      
#>  Min.   :0.000   Min.   :0.0000   Min.   :0.0000   Length:6871        Min.   : 0.00   Min.   :0.000000   Min.   :0.0000  
#>  1st Qu.:0.000   1st Qu.:1.0000   1st Qu.:1.0000   Class :character   1st Qu.: 4.00   1st Qu.:0.000000   1st Qu.:0.0000  
#>  Median :0.000   Median :1.0000   Median :1.0000   Mode  :character   Median : 5.00   Median :0.000000   Median :0.0000  
#>  Mean   :0.247   Mean   :0.8395   Mean   :0.8395                      Mean   : 5.96   Mean   :0.004803   Mean   :0.4091  
#>  3rd Qu.:0.000   3rd Qu.:1.0000   3rd Qu.:1.0000                      3rd Qu.: 8.00   3rd Qu.:0.000000   3rd Qu.:1.0000  
#>  Max.   :1.000   Max.   :1.0000   Max.   :1.0000                      Max.   :18.00   Max.   :1.000000   Max.   :7.0000  
#>                                                                                                                          
#>      sizec2         size2added       repstra2         repstrb2         repstr2added        feca2            fecb2         
#>  Min.   :0.0000   Min.   :0.000   Min.   :0.0000   Min.   :0.000000   Min.   :0.0000   Min.   :0.0000   Min.   :0.000000  
#>  1st Qu.:0.0000   1st Qu.:0.000   1st Qu.:0.0000   1st Qu.:0.000000   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.000000  
#>  Median :0.0000   Median :1.000   Median :0.0000   Median :0.000000   Median :0.0000   Median :0.0000   Median :0.000000  
#>  Mean   :0.6656   Mean   :1.079   Mean   :0.4091   Mean   :0.004803   Mean   :0.4139   Mean   :0.4091   Mean   :0.004803  
#>  3rd Qu.:1.0000   3rd Qu.:1.000   3rd Qu.:1.0000   3rd Qu.:0.000000   3rd Qu.:1.0000   3rd Qu.:1.0000   3rd Qu.:0.000000  
#>  Max.   :7.0000   Max.   :7.000   Max.   :7.0000   Max.   :1.000000   Max.   :7.0000   Max.   :7.0000   Max.   :1.000000  
#>                                                                                                                           
#>    fec2added        obsstatus2      repstatus2       fecstatus2       matstatus2     alive2     stage2           stage2index    
#>  Min.   :0.0000   Min.   :0.000   Min.   :0.0000   Min.   :0.0000   Min.   :1    Min.   :1   Length:6871        Min.   : 4.000  
#>  1st Qu.:0.0000   1st Qu.:0.000   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:1    1st Qu.:1   Class :character   1st Qu.: 4.000  
#>  Median :0.0000   Median :1.000   Median :0.0000   Median :0.0000   Median :1    Median :1   Mode  :character   Median : 5.000  
#>  Mean   :0.4139   Mean   :0.697   Mean   :0.2969   Mean   :0.2969   Mean   :1    Mean   :1                      Mean   : 7.158  
#>  3rd Qu.:1.0000   3rd Qu.:1.000   3rd Qu.:1.0000   3rd Qu.:1.0000   3rd Qu.:1    3rd Qu.:1                      3rd Qu.:12.000  
#>  Max.   :7.0000   Max.   :1.000   Max.   :1.0000   Max.   :1.0000   Max.   :1    Max.   :1                      Max.   :18.000  
#>                                                                                                                                 
#>      sizea3             sizeb3           sizec3         size3added        repstra3         repstrb3         repstr3added  
#>  Min.   :0.000000   Min.   :0.0000   Min.   :0.0000   Min.   :0.0000   Min.   :0.0000   Min.   :0.000000   Min.   :0.000  
#>  1st Qu.:0.000000   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.000000   1st Qu.:0.000  
#>  Median :0.000000   Median :0.0000   Median :0.0000   Median :1.0000   Median :0.0000   Median :0.000000   Median :0.000  
#>  Mean   :0.004221   Mean   :0.3308   Mean   :0.5523   Mean   :0.8874   Mean   :0.3308   Mean   :0.004221   Mean   :0.335  
#>  3rd Qu.:0.000000   3rd Qu.:0.0000   3rd Qu.:1.0000   3rd Qu.:1.0000   3rd Qu.:0.0000   3rd Qu.:0.000000   3rd Qu.:0.000  
#>  Max.   :2.000000   Max.   :7.0000   Max.   :7.0000   Max.   :7.0000   Max.   :7.0000   Max.   :2.000000   Max.   :7.000  
#>                                                                                                                           
#>      feca3            fecb3            fec3added       obsstatus3      repstatus3       fecstatus3       matstatus3     alive3     
#>  Min.   :0.0000   Min.   :0.000000   Min.   :0.000   Min.   :0.000   Min.   :0.0000   Min.   :0.0000   Min.   :1    Min.   :0.000  
#>  1st Qu.:0.0000   1st Qu.:0.000000   1st Qu.:0.000   1st Qu.:0.000   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:1    1st Qu.:1.000  
#>  Median :0.0000   Median :0.000000   Median :0.000   Median :1.000   Median :0.0000   Median :0.0000   Median :1    Median :1.000  
#>  Mean   :0.3308   Mean   :0.004221   Mean   :0.335   Mean   :0.571   Mean   :0.2391   Mean   :0.2391   Mean   :1    Mean   :0.874  
#>  3rd Qu.:0.0000   3rd Qu.:0.000000   3rd Qu.:0.000   3rd Qu.:1.000   3rd Qu.:0.0000   3rd Qu.:0.0000   3rd Qu.:1    3rd Qu.:1.000  
#>  Max.   :7.0000   Max.   :2.000000   Max.   :7.000   Max.   :1.000   Max.   :1.0000   Max.   :1.0000   Max.   :1    Max.   :1.000  
#>                                                                                                                                    
#>     stage3           stage3index    
#>  Length:6871        Min.   : 0.000  
...
#> Data: fec.data
#>       AIC       BIC    logLik -2*log(L)  df.resid 
#>  4826.427  4865.771 -2406.213  4812.427      2033 
#> Random-effects (co)variances:
#> 
#> Conditional model:
#>  Groups  Name        Std.Dev. 
#>  year2   (Intercept) 0.0002205
#>  individ (Intercept) 0.0003349
#> 
#> Zero-inflation model:
#>  Groups  Name        Std.Dev.
#>  year2   (Intercept) 1.81323 
#>  individ (Intercept) 0.03543 
#> 
...
#> Fecundity model R-squared is 0.481.
...
```
  ...
  <p style="text-indent: 20px">The output of the vital rate modeling exercise is worth looking over. Note that our best-fit models vary in interesting ways. For example, increasing size has a negative impact on survival, while reproductive status has a positive impact. These patterns suggest interesting trade-offs that might constrain natural selection. Also note the model accuracy in the best-fit models, which includes some models with high accuracy (e.g., survival, at around 88%), and others with fairly low accuracy (e.g., primary size, with roughly 27%).</p>
...
![plot of chunk ch2.7](ch2.7-1.png)
  ...
  <p style="text-indent: 20px">Next, we will set a trait axis defining all variants to test. Here, we will use 10 variants total, and please note that the resulting analysis may take a while to run.</p>
...
```
  ...
  *****Need a summary statement*****
  ...
  <p style="text-indent: 20px">As before, we can take a peek at what some of these simulations look like. We will try two different runs. Note that if the number of trait variants is set to less than 8, then there will be no run 50 and that line will lead to an error.</p>
...
![plot of chunk ch2.10](ch2.10-1.png)
...
#>  [801]  1.00000000  0.20000000  0.05689552  0.01625870  0.81631092  0.85617878  0.56884989  0.31025232  0.43997450  0.65096681
#>  [811]  0.69512922  0.58301000  0.51712301  0.56799126  0.64854320  0.66602652  0.63535322  0.62218076  0.64906498  0.68385887
#>  [821]  0.69681686  0.69441208  0.69906616  0.71728093  0.73767113  0.75057789  0.75876312  0.76980312  0.78553886  0.80194955
#>  [831]  0.81592588  0.82858892  0.84249309  0.85813917  0.87411811  0.88943722  0.90453951  0.92028509  0.93680407  0.95360756
#>  [841]  0.97038336  0.98730467  1.00466246  1.02248994  1.04062084  1.05896053  1.07757791  1.09657379  1.11595848  1.13567851
#>  [851]  1.15570856  1.17607825  1.19682534  1.21795603  1.23945633  1.26132310  1.28357165  1.30621919  1.32927205  1.35273025
#>  [861]  1.37659801  1.40088575  1.42560433  1.45076091  1.47636079  1.50241091  1.52892037  1.55589839  1.58335304  1.61129189
#>  [871]  1.63972323  1.66865616  1.69809991  1.72806337  1.75855546  1.78958543  1.82116290  1.85329765  1.88599949  1.91927833
#>  [881]  1.95314432  1.98760788  2.02267958  2.05837016  2.09469048  2.13165167  2.16926504  2.20754211  2.24649460  2.28613441
#>  [891]  2.32647366  2.36752470  2.40930010  2.45181264  2.49507531  2.53910136  2.58390425  2.62949770  2.67589566  2.72311231
#>  [901]  2.77116211  2.82005976  2.86982021  2.92045869  2.97199070  3.02443199  3.07779862  3.13210692  3.18737349  3.24361525
#>  [911]  3.30084940  3.35909345  3.41836524  3.47868288  3.54006483  3.60252988  3.66609713  3.73078604  3.79661639  3.86360832
#>  [921]  3.93178234  4.00115930  4.07176042  4.14360732  4.21672195  4.29112671  4.36684435  4.44389803  4.52231134  4.60210826
#>  [931]  4.68331321  4.76595103  4.85004700  4.93562686  5.02271678  5.11134342  5.20153388  5.29331576  5.38671715  5.48176662
#>  [941]  5.57849324  5.67692662  5.77709686  5.87903462  5.98277108  6.08833798  6.19576762  6.30509287  6.41634717  6.52956457
#>  [951]  6.64477969  6.76202780  6.88134477  7.00276709  7.12633192  7.25207706  7.38004099  7.51026285  7.64278248  7.77764044
#>  [961]  7.91487797  8.05453707  8.19666047  8.34129164  8.48847484  8.63825509  8.79067823  8.94579089  9.10364052  9.26427541
#>  [971]  9.42774471  9.59409844  9.76338749  9.93566365 10.11097963 10.28938907 10.47094655 10.65570762 10.84372881 11.03506763
#>  [981] 11.22978263 11.42793338 11.62958051 11.83478570 12.04361175 12.25612253 12.47238306 12.69245951 12.91641922 13.14433069
#>  [991] 13.37626365 13.61228908 13.85247916 14.09690740 14.34564857 14.59877877 14.85637544 15.11851740 15.38528485 15.65675940
#> [1001] 15.93302410
```
...
![plot of chunk ch2.12](ch2.12-1.png)

  <p style="text-indent: 20px">A fairly beautiful PIP, if I say so myself! We find that there appears to be an ESS value for sprouting. More to come as this package develops....</p>
