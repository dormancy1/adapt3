...
![plot of chunk ch2-1.8](ch2-1.8-1.png)
...
![plot of chunk ch2-1.10](ch2-1.10-1.png)
...
![plot of chunk ch2-2.7](ch2-2.7-1.png)
...
![plot of chunk ch2-2.11](ch2-2.11-1.png)
...
![plot of chunk ch2-2.13](ch2-2.13-1.png)
...
```
  <p style="text-indent: 20px">Our converged ESS value is at a slightly negative additive deviation to our sprouting probability y-intercept, meaning that our observed value appears to be an ESS. This is exactly what was found in @shefferson_life_2014, so we've done well.</p>
